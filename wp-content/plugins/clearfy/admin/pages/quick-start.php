	...
	class WbcrClr_QuickStartPage extends WbcrClr_Page {
		...
		public function showPageContent()
		{
			...
			$allow_mods = apply_filters('wbcr_clearfy_allow_quick_mods', array(
				'reset' => array('title' => __('Reset all settings', 'clearfy'), 'icon' => 'fa-history'),
				'recommended' => array('title' => __('Recommended Mode', 'clearfy'), 'icon' => 'fa-thumbs-o-up'),
				'clear_code' => array('title' => __('Code Clearing', 'clearfy'), 'icon' => 'fa-tachometer'),
				'defence' => array('title' => __('Security', 'clearfy'), 'icon' => 'fa-shield'),
				'seo_optimize' => array('title' => __('Seo optimization', 'clearfy'), 'icon' => 'fa-star-o'),
