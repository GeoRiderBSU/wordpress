	...
	class WbcrUpm_UpdatesPage extends FactoryPages322_ImpressiveThemplate {
		...
		public function getOptions()
		{
			...
			$options[] = array(
				...
				'data' => array(
					array('enable_plugin_monual_updates', __('Monual updates', 'webcraftic-updates-manager')),
			...
			$options[] = array(
				...
				'data' => array(
					array('enable_theme_monual_updates', __('Monual updates', 'webcraftic-updates-manager')),
			...
			$options[] = array(
				...
				'data' => array(
					...
					array('allow_minor_core_auto_updates', __('Allow minor auto updates', 'webcraftic-updates-manager')),
					array('allow_major_core_auto_updates', __('Allow major auto updates', 'webcraftic-updates-manager')),
					array('allow_dev_core_auto_updates', __('Allow development auto updates', 'webcraftic-updates-manager'))
				),
				'layout' => array('hint-type' => 'icon', 'hint-icon-color' => 'grey'),
