	...
	abstract class FactoryPages322_ImpressiveThemplate extends FactoryPages322_AdminPage {
		...
		protected function showHeader()
		{
			...
			<div class="wbcr-factory-page-header">
				...
				<?php if( $this->type == 'options' ): ?>
					...
					<input name="<?= $this->plugin->pluginName ?>_save_action" class="wbcr-factory-type-save" type="submit" value="<? _e('Save settings', 'factory_pages_322'); ?>">
		...
		public function showInfoWidget()
		{
			...
			<div class="wbcr-factory-sidebar-widget">
				<ul>
					<li>
						<span class="wbcr-factory-hint-icon-simple wbcr-factory-simple-red"><i class="fa fa-question" aria-hidden="true"></i></span>
						- <?php _e('A neutral setting that can not harm your site, but you must be sure that you need to use it.', 'factory_pages_322'); ?>
					</li>
					<li>
						<span class="wbcr-factory-hint-icon-simple wbcr-factory-simple-grey"><i class="fa fa-question" aria-hidden="true"></i></span>
					...
					<li>
						<span class="wbcr-factory-hint-icon-simple wbcr-factory-simple-green"><i class="fa fa-question" aria-hidden="true"></i></span>
		...
		public function showDonateWidget()
		{
			...
			<div class="wbcr-factory-sidebar-widget">
				<p>
					<strong><?php _e('Donation for plug-in development', 'factory_pages_322'); ?></strong>
				</p>
