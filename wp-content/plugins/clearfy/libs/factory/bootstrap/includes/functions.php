		...
		public function loadAssets($hook)
		{
			...
			if( !$compression ) {
				...
				foreach($this->scripts as $scriptToLoad) {
					// Issue #CLRF-6
					// Fix bug if assets exist
					if( !file_exists(FACTORY_BOOTSTRAP_330_DIR . "/assets/js/$scriptToLoad.js") ) {
						continue;
					}
				...
				foreach($this->styles as $styleToLoad) {
					// Issue #CLRF-6
					// Fix bug if assets exist
					if( !file_exists(FACTORY_BOOTSTRAP_330_DIR . "/assets/flat/css/$styleToLoad.css") ) {
						continue;
					}
